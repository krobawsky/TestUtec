      ...
      <div>
         {alumno.resultados.map(resultado => {
            ...
            <div>{resultado.valores.map((valor, index) => {
                 ...
                 valoresGen.push({val: total1 / valores1.length , tipo: 'A'});
                 valoresGen.push({val: total2 / valores2.length , tipo: 'AD'});
                 valoresGen.push({val: total3 / valores3.length , tipo: 'AE'});
                 valoresGen.push({val: total4 / valores4.length , tipo: 'BSE'});
                 valoresGen.push({val: total5 / valores5.length , tipo: 'BSS'});
                 valoresGen.push({val: total6 / valores6.length , tipo: 'CI'});
                 valoresGen.push({val: total7 / valores7.length , tipo: 'D'});
                 valoresGen.push({val: total8 / valores8.length , tipo: 'N'});
                 valoresGen.push({val: total9 / valores9.length , tipo: 'PA'});
                 valoresGen.push({val: total10 / valores10.length , tipo: 'RPE'});
                 valoresGen.push({val: total11 / valores11.length , tipo: 'RR'});
                 valoresGen.push({val: total12 / valores12.length , tipo: 'RA'});
                 valoresGen.push({val: total13 / valores13.length , tipo: 'SAC'});
