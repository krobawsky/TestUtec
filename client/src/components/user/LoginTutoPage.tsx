...
import ValidatorFormTuto from './ValidatorFormTuto';
...
export default () => <ValidatorFormTuto initialUser={newUser()} />;

// export default class LoginPage extends React.Component<void, INewOwnerPageState> {
