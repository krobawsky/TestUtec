...
public class ClinicServiceImpl implements ClinicService {
    ...
    @Autowired
    public ClinicServiceImpl(ValorRepository valoresRepository,PetRepository petRepository, VetRepository vetRepository, OwnerRepository ownerRepository, VisitRepository visitRepository, AlumnoRepository alumnoRepository, ResultadoRepository resultadoRepository, GrupoRepository grupoRepository, TestRepository testRepository) {
